 ...
 */
 ! function(e, t) {
  ...
  const P = (e, t) => {
          ...
          (i.preventClicks || i.preventClicksPropagation) && n[p]("click", e.onClick, !0), i.cssMode && l[p]("scroll", e.onScroll), i.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", $, !0) : e[u]("observerUpdate", $, !0)
      },
  ...
  const I = {
          ...
          events: {
              attachEvents: function() {
                  ...
                  }.bind(e), i.touch && !S && (t.addEventListener("touchstart", M), S = !0), P(e, "on")
              },
  ...
  class A {
      constructor(...e) {
          ...
          const r = f({}, z, i);
          return a.params = f({}, r, L, s), a.originalParams = f({}, a.params), a.passedParams = f({}, s), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
  ...
  const V = [function({
      ...
      function c() {
          ...
          if (e.params.navigation = D(e, e.originalParams.navigation, e.params.navigation, {
      ...
      function c() {
          ...
          if ("fraction" === s.type && (c.find(G(s.currentClass)).text(s.formatFractionCurrent(p + 1)), c.find(G(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
              let t;
              t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
              const a = (p + 1) / u;
              let i = 1,
                  r = 1;
              "horizontal" === t ? i = a : r = a, c.find(G(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${r})`).transition(e.params.speed)
          }
      ...
      function h() {
          ...
          s.removeClass(t.hiddenClass), s.removeClass(t.modifierClass + t.type), s.removeClass(t.modifierClass + e.params.direction), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && s.off("click", G(t.bulletClass))
      }
      s("init", () => {
          u(), p(), c()
      }), s("activeIndexChange", () => {
      ...
      function T() {
          ...
          e.params.scrollbar = D(e, e.originalParams.scrollbar, e.params.scrollbar, {
              el: "swiper-scrollbar"
          });
      ...
      s("beforeInit", () => {
          ...
          e.params.a11y.enabled && (function() {
              ...
              }), e.navigation && e.navigation.$nextEl && (m = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (v = e.navigation.$prevEl), m && m.length && g(m, r, t.nextSlideMessage), v && v.length && g(v, r, t.prevSlideMessage), f() && e.pagination.$el.on("keydown", G(e.params.pagination.bulletClass), h)
          }(), m())
      }), s("toEdge", () => {
          ...
          e.params.a11y.enabled && function() {
              let t, s;
              a && a.length > 0 && a.remove(), e.navigation && e.navigation.$nextEl && (t = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (s = e.navigation.$prevEl), t && t.off("keydown", h), s && s.off("keydown", h), f() && e.pagination.$el.off("keydown", G(e.params.pagination.bulletClass), h)
          }()
      })
  }, function({
      swiper: e,
      ...
      Object.assign(e, {
          ...
          prependSlide: B.bind(e),
          addSlide: X.bind(e),
          removeSlide: H.bind(e),
      ...
      t({
          ...
          setTransition: t => {
              ...
              (s ? e.slides.find(s) : e.slides).transition(t), j({
                  swiper: e,
                  duration: t,
                  transformEl: s,
                  allSlides: !0
      ...
      t({
          ...
          setTranslate: () => {
              ...
              for (let i = 0; i < t.length; i += 1) {
                  ...
                  if (e.isHorizontal() ? s && (o = -o) : (p = c, c = 0, d = -o, o = 0), r[0].style.zIndex = -Math.abs(Math.round(n)) + t.length, a.slideShadows) {
                      ...
                      0 === t.length && (t = _(a, r, e.isHorizontal() ? "left" : "top")), 0 === s.length && (s = _(a, r, e.isHorizontal() ? "right" : "bottom")), t.length && (t[0].style.opacity = Math.max(-n, 0)), s.length && (s[0].style.opacity = Math.max(n, 0))
                  }
          ...
          setTransition: t => {
              ...
              (s ? e.slides.find(s) : e.slides).transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t), j({
                  swiper: e,
                  duration: t,
                  transformEl: s
              })
      ...
      t({
          ...
          setTranslate: () => {
              ...
              for (let e = 0, t = a.length; e < t; e += 1) {
                  ...
                  if (R(r, t).transform(w), t[0].style.zIndex = 1 - Math.abs(Math.round(l)), r.slideShadows) {
                      let e = n ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                          s = n ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
                      0 === e.length && (e = _(r, t, n ? "left" : "top")), 0 === s.length && (s = _(r, t, n ? "right" : "bottom")), e.length && (e[0].style.opacity = l > 0 ? l : 0), s.length && (s[0].style.opacity = -l > 0 ? -l : 0)
                  }
              }
          },
          setTransition: t => {
      ...
      W({
          ...
          setTranslate: () => {
              ...
              for (let r = 0; r < t.length; r += 1) {
                  ...
                  if (u && h.shadow || !u) {
                      ...
                      if (0 === e.length && h.shadow && (e = _(s, n)), e.length) {
          ...
          setTransition: t => {
              ...
              (s ? e.slides.find(s) : e.slides).transition(t).find(".swiper-slide-shadow").transition(t), j({
                  swiper: e,
                  duration: t,
                  transformEl: s
              })
          ...
          setTranslate: () => {
              ...
              for (let l = 0; l < t.length; l += 1) {
                  ...
                  if (a.slideShadows) {
                      ...
                      0 === e.length && (e = _(a, o)), e.length && (e[0].style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1))
                  }
                  o[0].style.zIndex = -Math.abs(Math.round(d)) + t.length, R(a, o).transform(x)
              }
          },
          setTransition: t => {
              const {
